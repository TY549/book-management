...
public class Book extends TableImpl<BookRecord> {
     ...
     */
    public final TableField<BookRecord, String> PUBLICATION_STATUS = createField(DSL.name("publication_status"), SQLDataType.VARCHAR(20).nullable(false), this, "");
    ...
    /**
     * Get the implicit to-many join path to the <code>public.bookauthor</code>
     * table
     */
    public BookauthorPath bookauthor() {
        if (_bookauthor == null)
            _bookauthor = new BookauthorPath(this, null, Keys.BOOKAUTHOR__BOOKAUTHOR_BOOK_ID_FKEY.getInverseKey());
    ...
    public List<Check<BookRecord>> getChecks() {
        return Arrays.asList(
            ...
            Internal.createCheck(this, DSL.name("book_publication_status_check"), "(((publication_status)::text = ANY ((ARRAY['未出版'::character varying, '出版済み'::character varying])::text[])))", true)
        );
    }
