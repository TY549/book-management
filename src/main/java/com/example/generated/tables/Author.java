...
public class Author extends TableImpl<AuthorRecord> {
    ...
    public BookauthorPath bookauthor() {
        if (_bookauthor == null)
            _bookauthor = new BookauthorPath(this, null, Keys.BOOKAUTHOR__BOOKAUTHOR_AUTHOR_ID_FKEY.getInverseKey());
    ...
    public List<Check<AuthorRecord>> getChecks() {
        return Arrays.asList(
            Internal.createCheck(this, DSL.name("author_birth_date_check"), "((birth_date < CURRENT_DATE))", true)
        );
    }
